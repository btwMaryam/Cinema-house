import {
  ...
  const TicketScreen = () => {
    ...
    return (
      <SafeAreaView style={{marginTop:20, marginBottom:50}}>
        <View
          style={{
        ...
        >
          <Text style={{textAlign:"center",color:"white",fontSize:15}}>Logout</Text>
        </Pressable>
        </View>
      </SafeAreaView>
    );
